<template>
    <div class="componente-nav">
        ...
        <div class="nav-menu" transition-style="in:wipe:down">
            <div class="nav-item">
                <router-link to="/" id="cadPrestador" title="Ir para página Inicial">
                    <div class="link-item">
            ...
            <div class="nav-item">
                <router-link to="/cadPrestador" id="cadPrestador" title="Realizar um novo cadastro">
                    <div class="link-item">
                        ...
                        <p>Cadastrar Prestador</p>
                    </div>
                </router-link>
            </div>
            <div class="nav-item">
                <router-link to="/cadCategoria" title="Cadastrar nova categoria">
                    <div class="link-item">
