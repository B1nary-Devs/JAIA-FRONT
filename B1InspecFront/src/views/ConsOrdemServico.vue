        ...
        <div class="cons-ordem-body">
            <div v-for="os in ordem" :key="os.servicoId" class="card-cons">
                ...
                <div class="card-cons-actions">
                    <button @click="() => toggleModal('buttonTriggers')" class="card-button-view"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <ModalOrdem v-if="modalTriggers.buttonTriggers" :toggleModal="() => toggleModal('buttonTriggers')" >
                        <h2>Meu modal</h2>
                    </ModalOrdem>
                </div>
            </div>
